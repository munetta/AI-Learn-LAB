...
tansforming line: yes  ...transofrm 18 point incoming lines into one point, defined uniquely, to compare with the other lines already transformed and plotted as single points (the beginning to end of the lines, each individual node, can be used to transform into a single unique point)
parameters: pixel_location, pixel_color
algorithm: pixel_location * pixel_color + ...n
