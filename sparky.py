...
1. the unique point on a graph via its input set (parameters/constants and features/variables however do not confuse what is necessary and not, uniqueness is the goal) is used to create a regression model from scratch. Or the diffrence between lines, however lines can be transoformed into points.
...
line duration transformed: 18 y points... one point representing a millisecond and a frame 18 frames tied together to hopefully represent a basketball going through a hoop (saved for incoming targets) -- saved as unique point or as a line (unique point for easier comparison)
...
-create seperate models per click (when click, append to an inner model -- using times above 0s)                                                                                                                                                                                                                                               
