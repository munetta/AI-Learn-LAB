...
MAIN POINT IS SOME MODELS MIGHT NEED LINES WHILE OTHERS DO NOT - however if lines are neccessary, you can convert them into points to compare in a more friendly manner. Also the differential algorithm between lines might be computationally more expensive than say converting a line to a unique point then comparing. does that make f-sense. whether your red or blue just smash who you think is the man over and over. what else is there to life but the enthralling story of yada yada yada yada yada
