...
Regression mean formulas can be used for comparing stored unique lines, with incoming target lines (inefficent but possibly much more accurate labeling). -- The regression mean formulas always can indictate the center point variance for targets (excuse wording). 
